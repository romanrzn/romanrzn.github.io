...
main = function() {
  var Body, Canvas, CanvasOrtho, CanvasPersp, cube, distance, i, j, map, octahedron, op, ortho, orthoCube, perspective, perspectiveCube, reduce, rotate, sum, zip, zipWith;
  op = {
    plus: function(a, b) {
      return a + b;
    },
  ...
  Body = (function() {
    ...
    Body.prototype.viewTransform = function() {
      ...
      return (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          p = _ref[_i];
          _results.push([-p[0] * Math.sin(this.eye.theta) + p[1] * Math.cos(this.eye.theta), -p[0] * Math.cos(this.eye.phi) * Math.cos(this.eye.theta) - p[1] * Math.cos(this.eye.phi) * Math.sin(this.eye.theta) + p[2] * Math.sin(this.eye.phi)]);
        }
        return _results;
      }).call(this);
    };
    ...
    Body.prototype.screenTransform = function() {
      ...
      view = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          p = _ref[_i];
          _results.push([-p[0] * Math.sin(this.eye.theta) + p[1] * Math.cos(this.eye.theta), -p[0] * Math.cos(this.eye.phi) * Math.cos(this.eye.theta) - p[1] * Math.cos(this.eye.phi) * Math.sin(this.eye.theta) + p[2] * Math.sin(this.eye.phi), -p[0] * Math.sin(this.eye.phi) * Math.cos(this.eye.theta) - p[1] * Math.sin(this.eye.phi) * Math.sin(this.eye.theta) - p[2] * Math.cos(this.eye.phi) + this.eye.rho]);
        }
        return _results;
      }).call(this);
      screen = (function() {
        ...
        for (_i = 0, _len = view.length; _i < _len; _i++) {
          p = view[_i];
          _results.push([this.eye.zoom * p[0] / p[2], this.eye.zoom * p[1] / p[2]]);
        }
        return _results;
      }).call(this);
      return screen;
  ...
  octahedron = new Body({
      ...
      for (i = _i = 0; _i <= 5; i = ++_i) {
        _results.push((function() {
          ...
          for (j = _j = 0; _j <= 2; j = ++_j) {
            _results1.push((Math.pow(-1., i)) * (j === (Math.floor(i / 2))) * this.scale);
          }
          return _results1;
        }).call(this));
      }
    ...
    edgesIndices: (function(_this) {
      return function() {
        var i1, i2, ixs, p1, p2, _ref, _ref1;
        ixs = [];
        _ref = _this.world;
        for (i1 in _ref) {
          p1 = _ref[i1];
          ...
          for (i2 in _ref1) {
            ...
            if (distance(p1, p2) > (Math.sqrt(2) * _this.scale + 0.01)) {
              continue;
            }
            ixs.push([i1, i2]);
          }
  ...
  cube.world = (function() {
    ...
    for (i = _i = 0; _i <= 7; i = ++_i) {
      _results.push((function() {
        ...
        _results1 = [];
        for (j = _j = 0; _j <= 2; j = ++_j) {
          _results1.push(Math.pow(-1., (i >> j) & 1) * cube.scale);
        }
        return _results1;
      })());
    }
  ...
  cube.edgesIndices = (function(_this) {
    return function() {
      var i1, i2, ixs, p1, p2, _ref, _ref1;
      ixs = [];
      _ref = cube.world;
      for (i1 in _ref) {
        ...
        for (i2 in _ref1) {
          ...
          if (distance(p1, p2) > (2 * cube.scale + 0.01)) {
            continue;
          }
          ixs.push([i1, i2]);
        }
  ...
  cube.trianglesIndices = (function(_this) {
    return function() {
        ...
        return function(e) {
          ...
          switch (_this.modes[0]) {
            case 'zoom':
              ...
              _this.body.eye.zoom = 300 + 200 * Math.max(2 * x / _this.w, 0.1);
              break;
            case 'move':
              _this.body.eye.offsetX = x;
              _this.body.eye.offsetY = y;
              break;
            case 'rotate':
